...
* There does not seem to be an annual increase in mean avocado prices. Although there is a price spike in 2017. This coincides with the 2017 drought, the worst drought in 17 years. This could explain the possible price spike. 
...
* The tibble above shows the average price of avocaodes based on their type (Conventional or Organic). Organic avocadoes are a whopping 50 cents more on average! 


#### Conclusion
****
* Our objective was to manipulate data about avocado sales, in order to identify factors that will boost revenue for retailers. Together we created a general plot that compares the total volume of sales to the avergae price. We discovered that there was a separation in the plot when total volume reached 2e+07. The total volume that was less than 2e+07 displayed a weak negative correlation. While the total volume greater than 2e+07 showed a strong negative correlation. Individually we compared several factors that may affect the average price or total volume. From these plots, we noticed that region, type, and year affect both volume in sales and average price. The best course of action to maximize profit is to keep avocado prices low while in season, and upsale on pairings such as tortilla chips and artisan bread. Total number of sales are highest when they are in season and cheaper prices will attract the consumers, while upselling on tortilla chips and bread will add on to their total cost, therefore increasing revenue.


#### Data Description
****

*Overall, the data shows that there is a clear correlation between month and price of avocados as the prices rise until October and then fall quickly.  In addition, organic avocados appear to have a higher price than coventional based on the distribution and avocados also sell at cheapest prices in the south, especially Texas.  All of our data also supports the concept of supply and demand as volume rises when price goes down
```{r echo=FALSE}
```
### Individual Section
****
