...
* Findings: This graph shows that the there is a higher disribution of conventional avocados than organic avocados. From this graph it shows that the average price amoungst all regions is around $1.10 for conventional and $1.60 for organic.
* I used select to use the variables I wanted to work with. I grouped by region and type. I then took the average of each region with summarise. Then I created a ggplot with the new data variable I created. I wanted to compare the distribution of average price between conventional and organic avocados. So I used geom_density and faceted with type.
